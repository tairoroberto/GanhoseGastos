 ...
 * @author Tairo
 */
public class ItemListCategoriaGastosAdapter extends ArrayAdapter<CategoriaGasto> {
	 ...
	 */
	public ItemListCategoriaGastosAdapter(Context context, List<CategoriaGasto> items) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		// --
		final CategoriaGasto item = getItem(position);

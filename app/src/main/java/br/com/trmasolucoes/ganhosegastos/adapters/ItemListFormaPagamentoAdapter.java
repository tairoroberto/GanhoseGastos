 ...
 * @author Tairo
 */
public class ItemListFormaPagamentoAdapter extends ArrayAdapter<FormaPagamento> {
	 ...
	 */
	public ItemListFormaPagamentoAdapter(Context context, List<FormaPagamento> items) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		// --
		final FormaPagamento item = getItem(position);

		// Re-use the view if possible
		// --
		ViewHolder holder;
		if (convertView == null) {
			convertView = li.inflate(R.layout.lista_forma_pagamento_item, null);

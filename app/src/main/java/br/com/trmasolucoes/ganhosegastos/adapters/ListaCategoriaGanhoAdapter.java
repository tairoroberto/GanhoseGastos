 ...
 */
public class ListaCategoriaGanhoAdapter extends BaseAdapter {

    private List<CategoriaGanho> list;
    private Context context;

    public ListaCategoriaGanhoAdapter(Context context, List<CategoriaGanho> list) {
        this.list = list;
